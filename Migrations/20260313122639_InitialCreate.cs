    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "WiFi,Pool,Gym,Spa,Restaurant", "TP.HCM", null, null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4401), "Khách sạn 5 sao sang trọng tại TP.HCM", null, true, 5000000m, 1500000m, "Hotel De La Saigon", null, 5 },
                    { 2, null, "WiFi,Restaurant,Parking", "Hà Nội", null, null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4415), "Khách sạn 4 sao tại Hà Nội", null, true, 2500000m, 800000m, "Grand Hotel", null, 4 },
                    { 3, null, "WiFi,Pool,Restaurant,Beach", "Đà Nẵng", null, null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4417), "Khách sạn 4 sao view biển Đà Nẵng", null, true, 2800000m, 900000m, "Sea View Hotel", null, 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Tour", new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4631), "Giảm 20% cho tour mùa hè", 20, new DateTime(2026, 6, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4636), true, "Giảm giá mùa hè", true, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4634) },
                    { 2, "Hotel", new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4660), "Giảm 15% khi đặt 2 phòng", 15, new DateTime(2026, 5, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4661), true, "Combo khách sạn", true, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4661) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, "Pool,Spa,Gym,Beach,Restaurant", "Phú Quốc", null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4561), "Resort 5 sao bãi biển", null, true, 8000000m, 3000000m, "Paradise Resort", 4.8m, "Biển", 5 },
                    { 2, null, null, "Spa,Restaurant,View", "Sa Pa", null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4568), "Resort núi view đẹp", null, true, 4000000m, 1500000m, "Mountain View Resort", 4.5m, "Núi", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Hà Nội", null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4521), "Việt Nam", "Nhà hàng ẩm thực Việt Nam", true, null, true, null, "Nhà hàng Ẩm Thực", null, "Trung cấp", 4.2m, "Nhà hàng" },
                    { 2, null, "Đà Nẵng", null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4534), "Hải sản", "Nhà hàng hải sản tươi sống", true, null, true, null, "Ocean Blue", null, "Cao cấp", 4.5m, "Nhà hàng" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4331), "Vịnh Hạ Long - Di sản thiên nhiên thế giới với hàng nghìn đảo đá vôi", "/images/spots/ha-long.jpg", true, "Vịnh Hạ Long", 4.5m, "Miền Bắc", "Biển", null },
                    { 2, null, null, null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4346), "Đảo ngọc Phú Quốc với bãi biển đẹp", "/images/spots/phu-quoc.jpg", true, "Phú Quốc", 4.6m, "Miền Nam", "Biển", null },
                    { 3, null, null, null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4348), "Thành phố đáng sống với nhiều bãi biển đẹp", "/images/spots/da-nang.jpg", true, "Đà Nẵng", 4.7m, "Miền Trung", "Biển", null },
                    { 4, null, null, null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4350), "Thị trấn mù sương với cảnh quan núi rừng tuyệt đẹp", "/images/spots/sapa.jpg", true, "Sa Pa", 4.4m, "Miền Bắc", "Núi", null },
                    { 5, null, null, null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4351), "Cố đô Huế với di sản văn hóa phong phú", "/images/spots/hue.jpg", true, "Huế", 4.5m, "Miền Trung", "Di tích", null },
                    { 6, null, null, null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4353), "Thành phố biển xinh đẹp", "/images/spots/nha-trang.jpg", true, "Nha Trang", 4.6m, "Miền Trung", "Biển", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4440), 0, "Khám phá vịnh Hạ Long tuyệt đẹp", "Hạ Long", 3, null, null, null, null, true, true, null, 30, "Tour Hạ Long 3 ngày 2 đêm", 2500000m, null, null },
                    { 2, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4459), 0, "Nghỉ dưỡng tại đảo ngọc", "Phú Quốc", 4, null, null, null, null, true, true, null, 25, "Tour Phú Quốc 4 ngày 3 đêm", 4500000m, null, null },
                    { 3, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4461), 0, "Khám phá Đà Nẵng và phố cổ Hội An", "Đà Nẵng", 3, null, null, null, null, true, true, null, 30, "Tour Đà Nẵng - Hội An 3 ngày", 3200000m, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Karnel Travel", new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4488), "Hà Nội", null, true, "Xe Khách Hà Nội - Hạ Long", 150000m, "Hà Nội - Hạ Long", null, "Hạ Long", "Xe Khách" },
                    { 2, null, "Vietnam Airlines", new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4500), "TP.HCM", null, true, "Máy bay Sài Gòn - Phú Quốc", 1200000m, "TP.HCM - Phú Quốc", null, "Phú Quốc", "Máy bay" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "Address", "CreatedAt", "Email", "FullName", "IsActive", "PasswordHash", "Phone", "Role", "UpdatedAt" },
                values: new object[] { 1, null, new DateTime(2026, 3, 13, 19, 26, 38, 815, DateTimeKind.Local).AddTicks(4149), "admin@karneltravels.com", "Admin", true, "AQAAAAEAACcQAAAAEH encode your password", null, "Admin", null });
